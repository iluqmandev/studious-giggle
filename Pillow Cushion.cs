...
{
    public partial class Pillow_Cushion : Form
    {
        public Pillow_Cushion()
        {
            InitializeComponent();
        }
 ...
 double.Parse(dataGridView1.Rows[3].Cells[2].EditedFormattedValue.ToString());
        ...
        private void Pillow_Cushion_Load(object sender, EventArgs e)
        {
            ...
            // add rows
            table.Rows.Add(1, "BOTH SIDE  10 CM HEM", 0.63, 95, 3.87, 4, 3048);
            table.Rows.Add(2, "Reinforcement  ", 0.300, 200, 1.84, 2, 3200);
            table.Rows.Add(3, "O/L Bottom Side", 0.400, 150, 2.45, 2, 2400);
            table.Rows.Add(4, "Trimming", 0.300, 200,     1.84, 2, 3200);
