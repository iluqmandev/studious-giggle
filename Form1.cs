        ...
        private void Form1_Load(object sender, EventArgs e)
        {
         ...
         //   table.Columns.Add("TGT per Hours", typeof(int));
           // table.Columns.Add("TGT Per Day at 100% (8 Hours)", typeof(int));
            ...
            // add rows
            table.Rows.Add(1, "TOP HEM 10 CM",         0.68,   88, 2.39, 2, 1412);
            table.Rows.Add(2, "BOTTOM HEM 1 INCH ",    0.520, 115, 1.83, 2, 1846);
            table.Rows.Add(3, "SIDE HEM 1 CM ",        1.040, 58, 3.66, 4, 1846);
            table.Rows.Add(4, "Trimming",              0.6, 100, 2.11, 2, 1600);
    ...
    double.Parse(dataGridView1.Rows[3].Cells[2].EditedFormattedValue.ToString());
     ...
     double.Parse(dataGridView1.Rows[3].Cells[5].EditedFormattedValue.ToString());
      totalTML.Text = Ttml.ToString();
        ...
        private void txtTGT100_TextChanged(object sender, EventArgs e)
        {
